...
class CredentialService {
  ...
  static Future<CredentialService> createCredentials(String dragonchainId,
      {String authKeyId = '',
      String authKey = '',
      String hmacAlgo = 'SHA256'}) async {
  ...
  getAuthorizationHeader(String method, String path, String timestamp,
  ...
  static getHmacMessageString(String method, String path, String dragonchainId,
      String timestamp, String contentType, String hmacAlgo,
      [String body = '']) {
